...
<div id = "pinnedCountries">
    ...
    <div id="advisory" style="margin-left:40px; margin-right:40px; background-color:lightgrey">
        <div style="display:inline-block;vertical-align:top;padding:10px">
            <img src="https://i.pinimg.com/originals/f4/60/7f/f4607f44077947f21ffdcdb34c4cd850.png" style="width:30px;height:30px;">
        </div>
